<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Registrar cliente</h2>
                <p class="text-sm text-gray-600 dark:text-gray-300">Alta de un nuevo miembro y su membresía.</p>
            </div>
        ...
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
            <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                    <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Datos del cliente</h3>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">Completa los campos requeridos.</p>
                </div>
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select name="membresia" required
                                    ...
                                    <option value="basica" @selected(old('membresia')==='basica')>Básica</option>
                                    <option value="plus" @selected(old('membresia')==='plus')>Plus</option>
                                    <option value="premium" @selected(old('membresia')==='premium')>Premium</option>
                                </select>
                            </div>

                            <div>
                                <label class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Vigencia hasta</label>
                                <input type="date" name="vigencia_hasta" value="{{ old('vigencia_hasta') }}" required
                                       class="mt-2 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-gray-900
                                              focus:border-indigo-500 focus:ring-indigo-500
                                              dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100" />
                            </div>
                                ...
                                <div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
                                    <label class="flex items-center gap-3 rounded-lg border border-gray-300 bg-gray-50 px-4 py-3
                                        ...
                                        <input type="radio" name="estado" value="activa" required
                                               @checked(old('estado','activa')==='activa')>
                                        <div>
